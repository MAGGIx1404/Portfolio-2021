...
import hamb_vert from "../shaders/hamb_vert.glsl"
import hamb_frag from "../shaders/hamb_frag.glsl"
...
export default class hambGl{
    constructor(){
        this.container = document.querySelector('.hamb__inner__menu');
        this.links = [...document.querySelectorAll('.hamb__item')];
        ...
        this.addEventListeners(document.querySelector('.hamb__menu__inner'));
        this.setUpCamera();
        this.onMouseMove();
        this.createMesh();
        this.render()
    ...
    createMesh(){
        ...
        this.material = new THREE.ShaderMaterial({
            ...
            vertexShader: shaders.hamb_vert,
            fragmentShader: shaders.hamb_frag,
            transparent: true,
            // wireframe: true,
